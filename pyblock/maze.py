...
class Maze:
    ...
    def __init__(self, width = 10, height = 10, entry_point = None, exit_point = None, debug = False):
        """
        Initializes a maze.
    ...
    def choose_next(self):
        ...
        msg = f"Step {self.counter} -> Cell {self.x}/{self.y}  possible directions: {txt}.   "\
